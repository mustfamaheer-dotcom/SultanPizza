    ...
    <AnimatePresence mode="wait">
      {loading ? (
        <motion.div
          ...
          style={{
            position: 'fixed', inset: 0, zIndex: 9999, background: 'var(--darker)',
        ...
        <motion.div key="content" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.5 }}>
          ...
          <Contact />
          <footer style={{
            position: 'relative', zIndex: 1, textAlign: 'center', padding: '30px 20px',
            color: 'var(--text-dim)', fontSize: '0.9rem', background: 'var(--darker)',
